...
<div id="wrapper">
 ...
 <div id="navigation">
  <div class="navigation_bg_<?php print $nav_class; ?>">
    <?php
    if($nav_class == "greenoffice" || $nav_class == "green_office"){
  ...
  <div id="fp_main">
    <div id="fp_ss"><?php // slideshow ?>
      <?php if ($ss): print $ss; endif; ?>
    </div>
    <div id="fp_mini"><?php // q and a ?>
      <?php if ($fp_mini): print $fp_mini; endif; ?>
    </div>
    <div id="fp_widebar"><?php // q and a ?>
